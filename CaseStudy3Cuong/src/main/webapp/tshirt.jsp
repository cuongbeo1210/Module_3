...
<header class="header_area">
    <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
        ...
        <nav class="classy-navbar" id="essenceNav">
            <!-- Logo -->
            <a class="nav-brand" href="/home"><img src="img/core-img/error-fashion-icon1.png" width="140"
                                                   height="70" alt=""></a>
            <!-- Navbar Toggler -->
            ...
            <div class="col-12 col-md-8 col-lg-9">
                <div class="shop_grid_product_area">
                        ...
                        <div class="col-12">
                            <div class="product-topbar d-flex align-items-center justify-content-between">
                                ...
                                <div class="total-products">
                                    <p><span>${listProductByCategory.size()}</span> products found</p>
                                </div>
                                <!-- Sorting -->
                    ...
                    <div class="row">
                        ...
                        <!-- Single Product -->
                        <c:forEach items="${listProductByCategory}" var="cate">
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-img">
                                        ...
                                        <!-- Hover Thumb -->
                                        <img class="hover-img" src="${cate.thumbnail}" alt="">
                                    ...
                                    <div class="product-description">
                                        ...
                                        <a href="detail?productID=${cate.id}">
                                            <h6>${cate.title}</h6>
                                        </a>
                                        <p class="product-price"><span class="old-price">${cate.price} VND</span> ${cate.discount} VND</p>
